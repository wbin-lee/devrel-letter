        ...
        <div key={i} className="form-card">
          ...
          <div className="form-row">
            ...
            <input
              ...
              onChange={(e) => dispatch({ type: 'SET_ITEM_FIELD', section: 'ai4se', index: i, field: 'thumbnailUrl', value: e.target.value })}
              placeholder="https://dsdn..."
            />
          </div>
          <div className="form-row">
            <label>썸네일 이미지 (Email용 — component/AI4SE{i + 1}.*)</label>
            {item.thumbnailBase64 ? (
              <div className="image-preview">
                <img src={item.thumbnailBase64} alt={`AI4SE${i + 1} 썸네일`} />
              </div>
            ) : (
